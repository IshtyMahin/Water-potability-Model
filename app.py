...
interface = gr.Interface(
    ...
    inputs=[
        gr.Number(label="pH", value=6.0),
        gr.Number(label="Hardness", value=240),
        gr.Number(label="Solids", value=267600),
        gr.Number(label="Chloramines", value=7.9),
        gr.Number(label="Sulfate", value=370.45),
        gr.Number(label="Conductivity", value=355.63),
        gr.Number(label="Organic Carbon", value=11.5),
        gr.Number(label="Trihalomethanes", value=356.84),
        gr.Number(label="Turbidity", value=3.6),
    ],
